...
#     def __init__(self, img_ch=3,output_ch=2): # in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True, is_ds=True):
#         super(UNet_2Plus, self).__init__()
#         self.is_deconv = True
#         self.in_channels = img_ch
#         self.is_batchnorm = True
#         self.is_ds = False #True
...
#         else:
#             return final_4#F.sigmoid(final_4)
...
#     def __init__(self,  img_ch=3,output_ch=2): #, feature_scale=4, is_deconv=True, is_batchnorm=True):
...
#         self.outconv2 = nn.Conv2d(self.UpChannels, output_ch, 3, padding=1)
#         self.outconv3 = nn.Conv2d(self.UpChannels, output_ch, 3, padding=1)
#         self.outconv4 = nn.Conv2d(self.UpChannels, output_ch, 3, padding=1)
#         self.outconv5 = nn.Conv2d(filters[4], output_ch, 3, padding=1)
...
#         return (d1+d2+d3+d4+d5)/5 #F.sigmoid(d1), F.sigmoid(d2), F.sigmoid(d3), F.sigmoid(d4), F.sigmoid(d5)


#############Unet3+ without deep supervision
# import torch
# import torch.nn as nn
# import torch.nn.functional as F
# from torch.nn import init

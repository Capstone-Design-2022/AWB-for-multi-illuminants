...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', type=str, default='UNet_3Plus') #'U_Net' #UNet_3Plus #UNet_3Plus_DeepSup 
    ...
    parser.add_argument('--lr', type=float, default=55e-5) #5e-4=0.0005
    parser.add_argument('--num_epochs_decay', type=int, default=800) #800
    parser.add_argument('--beta1', type=float, default=0.5) #0.5->0.9
    ...
    parser.add_argument('--image_size', type=int, default=256) #224 for Swin
    ...
    parser.add_argument('--multi_gpu', type=int, default=1, choices=[1,2],

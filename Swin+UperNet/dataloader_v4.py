...
class PairedRandomCrop():
    def __init__(self,size=(224,224),scale=(0.3,1.0),ratio=(1.,1.)): #self,size=(256,256),scale=(0.3,1.0),ratio=(1.,1.)
        self.size = size
        self.scale = scale
        self.ratio = ratio
...
class Resize():
    def __init__(self,size=(224,224)): #self,size=(256,256)
        self.size = size
    def __call__(self,ret_dict):
